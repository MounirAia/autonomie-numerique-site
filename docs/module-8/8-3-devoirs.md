...
# 8.3 — Devoirs — Module 8

---

## Devoir 1 — Scanner des documents et envoyer par courriel

1. Scanner **3 documents différents** avec votre téléphone
   - Un document peut être une feuille de papier, une facture, un reçu, une carte, etc.
   - Utiliser une application de scan au choix : **Adobe Scan**, **Microsoft Lens**, ou l'application **Notes** sur iPhone
   - Sauvegarder chaque document en format PDF
2. Envoyer les **3 PDF en pièces jointes dans un seul courriel** au formateur
3. Ajouter du texte dans le corps du courriel pour décrire ce que vous avez scanné

---

## Devoir 2 — Envoyer des photos par courriel

1. Prendre **3 photos différentes** avec votre téléphone (n'importe quel sujet)
2. Envoyer les **3 photos en pièces jointes dans un seul courriel** au formateur
3. Ajouter du texte dans le corps du courriel pour décrire ce que vous avez photographié

---

## Devoir 3 — Vrai ou arnaque ?

Pour chacun des messages ci-dessous, décider s'il s'agit d'un message **légitime** ou d'une tentative **d'arnaque**.
